...
class Controls
{
    ...
    { 
        ...
        this.playBtn.innerHTML = '<img class="button-img" src="Ui/media/play.png" border="0" width="100%" height="auto" draggable="false">';
        ...
        this.pauseBtn.innerHTML = '<img class="button-img" src="Ui/media/pause.png" border="0" width="100%" height="auto" draggable="false">';
        ...
        this.resetBtn.innerHTML = '<img class="button-img" src="Ui/media/reset.png" border="0" width="100%" height="auto" draggable="false">';
